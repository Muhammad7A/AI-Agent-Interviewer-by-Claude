 ...
 * (ADR-0004, ADR-0005).
 *
 * Each `KnowledgeNode` is its own Aggregate Root (ADR-0006); this interface is
 * its **state contract** — behaviour is defined by the owning context, not here
 * (this package carries contracts only).
 *
 ...
 *  - N5 type-layer coherence: `layers` are consistent with `nodeType`.
